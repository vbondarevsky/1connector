...
Функция ОтправитьЗапрос(Сессия, ПодготовленныйЗапрос, Настройки)
	...
	Пока Истина Цикл
		...
		ДлительностьПриостановки = Мин(ДлительностьПриостановки, Настройки.МаксимальноеВремяПовторов - Длительность);
		Если ДлительностьПриостановки < 0 Тогда
			ДлительностьПриостановки = 0;
		КонецЕсли;
