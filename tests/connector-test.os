...
Функция ПолучитьСписокТестов(МенеджерТестирования) Экспорт
	...
	МассивТестов.Добавить("ТестДолжен_ПроверитьЧтоРаботаетОтключениеРедиректов");
...
Процедура ТестДолжен_ПроверитьЧтоРаботаетОтключениеРедиректов() Экспорт
	...
	Ожидаем.Что(Ответ.КодСостояния).Равно(307);
